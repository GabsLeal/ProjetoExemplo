...
<% List<Reserva> reservas =(List<Reserva>)request.getAttribute("listaRetirados");
...
for (Reserva reserva : reservas ){
	...
	out.print("<td>");
	out.print("<a  href='SalvarDataRetirado?operacao=SALVAR&idEstoque="+reserva.getId_estoque()+"&idLivro="+reserva.getId_livro()+"&idUsuario="+reserva.getId_usuario()+"&tipoUsuario="+reserva.getTipoUsuario()+"&reservaId="+reserva.getId()+"'><i'>Aprovar</i></a>");
	out.print("</td>");
	out.println("</tr>");
