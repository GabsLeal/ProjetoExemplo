...
for ( Livro livro : livros ){
	...
	out.print("<td>");
	out.print("<a  href='AlterarEstoque?operacao=ALTERAR&tipoUsuario=biblioteca&idLivro="+livro.getId()+"&idBiblioteca="+livro.getQuantidade().getId_biblioteca()+
			"&idUsuario="+bibliotecas.get(0).getId()+"&idEstoque="+livro.getQuantidade().getId() +"&qtEstoque="+livro.getQuantidade().getQuantidade()+"'><i'>Reservar</i></a>");
	out.print("</td>");
	out.println("</tr>");
