...
<body>
	...
	<div class="row">
		<form action="SalvarCliente" method="get" class="col s12">
			...
			<div class="input-field col s4">
				<input id="txtNascimento" name="txtNascimento" type="text" value="">
				<label for="txtNascimento">Nascimento</label>
			</div>
			<div class="input-field col s4">
				<input id="txtRP" type="text" name="txtRP" value=""> <label
					for="txtRP">Regristo de Professor</label>
			</div>
			<div class="input-field col s4">
			...
			<div id="origem">
				...
				<div class="input-field col s4">
					<input id="txtVencimento" name="txtVencimento" type="text" value="">
					<label for="txtVencimento">Data de Admissao</label>
				</div>
