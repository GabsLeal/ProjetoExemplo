...
for (Reserva retirado : retirados ){
	...
	out.print("<td>");
	out.print("<a  href='AlterarReserva?operacao=ALTERAR&tipoUsuario=biblioteca&condicao=DEVOLVER&idUsuario="+bibliotecas.get(0).getId()+"&reservaId="+retirado.getId()+"'><i'>Devolver</i></a>");
	out.print("</td>");
	out.println("</tr>");
